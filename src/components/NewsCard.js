...
const NewsCard = ({news, theme}) => {
  ...
  return (
    ...
    <div className={`flex ml-16 rounded-xl shadow-lg h-full
      ...
      <div className={`px-2 py-2 shadow-lg hover:shadow-2xl`}>
        ...
        <div>
          <img className='w-[18rem] rounded-md h-48' src={ imageUrl} alt="thumbnail" />
        </div>

        <div className='mt-2'>
          <p className="w-[18rem] font-semibold">{title}</p>
